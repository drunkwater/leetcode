...
int main( int argc, char *argv[] )
{
	...
	//char *strs[] = {"ab", "abc", "abcd", "abcde", "abf", "ab"};
	//char *strs[] = {"xab", "abc", "abcd", "abcde", "abf", "ab"};
	//char *strs[] = {"ab", "abc", "abcd", "abcde", "a", "ab"};
	char *strs[] = {"ab", "abc", "abcd", "abcde", "a", "ab"};
	int strsSize = sizeof(strs)/sizeof(strs[0]);
	fprintf(stderr, "common prefix is '%s'\n", longestCommonPrefix(strs, strsSize));
