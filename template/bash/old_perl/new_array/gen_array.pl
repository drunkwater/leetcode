...
sub negative_array_0_65535
{
	...
	print $cArrayFileRef "\nstatic int negative_array_0_65535[". $size ."] = {";
	#scalar
	for (my $line=0; $line<$maxLine; $line++)
	{
		for (my $offset=0; $offset<$maxSizePerLine; $offset++)
...
sub negative_array_65535_0
{
	...
	print $cArrayFileRef "\nstatic int negative_array_65535_0[". $size ."] = {";
	#scalar
	for (my $line=0; $line<$maxLine; $line++)
	{
		for (my $offset=$maxSizePerLine-1; $offset>=0; $offset--)
...
sub negative_array_65535_odd
{
	...
	print $cArrayFileRef "\nstatic int negative_array_65535_odd[". $size ."] = {";
	#scalar
	for (my $line=0; $line<$maxLine; $line++)
	{
		for (my $offset=0; $offset<$maxSizePerLine; $offset++)
...
sub negative_array_65535_even
{
	...
	print $cArrayFileRef "\nstatic int negative_array_65535_even[". $size ."] = {";
...
sub negative_array_65535_random
{
	my $cArrayFileRef = $_[0];
	my $maxSizePerLine = 65_536;
	my $maxLine = 4;
	...
	print $cArrayFileRef "\nstatic int negative_array_65535_random[". $size ."] = {";
...
sub array_65535_random_200
{
	...
	print $cArrayFileRef "\nstatic int array_65535_random_200[". $size ."] = {";
	...
	for (my $line=0; $line<$maxLine; $line++)
	{
		for (my $offset=0; $offset<$maxSizePerLine; $offset++)
		{
			...
			my $hex = sprintf("%d", int(rand(200+1)));
			print $cArrayFileRef $hex . ",";
		}
...
sub main
{
	...
	negative_array_0_65535($cArrayFileRef);
	negative_array_65535_0($cArrayFileRef);
	negative_array_65535_odd($cArrayFileRef);
	negative_array_65535_even($cArrayFileRef);
	negative_array_65535_random($cArrayFileRef);


	array_65535_random_200($cArrayFileRef);
