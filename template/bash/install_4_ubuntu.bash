...
#apt-get install -y  liblzma5:i386;ldconfig
#ln -sf  /lib/i386-linux-gnu/liblzma.so.5.0.0  /usr/lib/liblzma.so.0; ldconfig
...
#apt-get install -y  libselinux1-dev:i386


#test@church:~$ getconf LONG_BIT
#64
